...
public class ParseOptionalTest extends ParseSimpleTest<ParseLiteralConfig> {
    ...
    public static Collection<?> generateTestDatas() {
        ...
        return asList( //
                makeTestData("no match", 0, " flow", config, -1, 0, null, 0, 1), //
                makeTestData("match", 0, "flow", config, -1, 0, "flow", 4, 0) //
        );
    }

    public ParseOptionalTest(ParserData parserData, ParseLiteralConfig config, ParseResult expectedResult,
